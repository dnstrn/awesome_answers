class Question < ActiveRecord::Base
  ...
  # validates_presence_of :title # deprecated
  ...
  # it means that title by itself doesn't have to be unique and body by itself
  # doesn't have to be unique but the combination of the two must be unique

  # validates :title, uniqueness: {scope::body}
  # we use 'validate' to reference a method that will be used for our custom validation
